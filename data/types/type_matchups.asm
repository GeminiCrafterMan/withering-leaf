...
;	db GROUND,    FLYING,    NO_EFFECT -- checks airborne state instead
	...
	db SHADOW,    NORMAL,    SUPER_EFFECTIVE
	db SHADOW,    FIGHTING,  SUPER_EFFECTIVE
	db SHADOW,    FLYING,    SUPER_EFFECTIVE
	db SHADOW,    POISON,    SUPER_EFFECTIVE
	db SHADOW,    GROUND,    SUPER_EFFECTIVE
	db SHADOW,    ROCK,      SUPER_EFFECTIVE
	db SHADOW,    BUG,       SUPER_EFFECTIVE
	db SHADOW,    GHOST,     SUPER_EFFECTIVE
	db SHADOW,    STEEL,     SUPER_EFFECTIVE
	db SHADOW,    FIRE,      SUPER_EFFECTIVE
	db SHADOW,    WATER,     SUPER_EFFECTIVE
	db SHADOW,    GRASS,     SUPER_EFFECTIVE
	db SHADOW,    ELECTRIC,  SUPER_EFFECTIVE
	db SHADOW,    PSYCHIC,   SUPER_EFFECTIVE
	db SHADOW,    ICE,       SUPER_EFFECTIVE
	db SHADOW,    DRAGON,    SUPER_EFFECTIVE
	db SHADOW,    DARK,      SUPER_EFFECTIVE
	db SHADOW,    FAIRY,     SUPER_EFFECTIVE
	db FAIRY,     SHADOW,    SUPER_EFFECTIVE
	db SHADOW,    SHADOW,    NOT_VERY_EFFECTIVE
