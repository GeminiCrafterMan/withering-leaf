RockTunnelB1F_MapScriptHeader:
	...
	object_event 24, 24, SPRITE_HEX_MANIAC_F, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 2, GenericTrainerHexManiacFVivian, -1
...
GenericTrainerHexManiacFVivian:
	generictrainer HEX_MANIAC_F, VIVIAN, EVENT_BEAT_HEX_MANIAC_F_VIVIAN, HexManiacFVivianSeenText, HexManiacFVivianBeatenText
...
HexManiacFVivianSeenText:
	text "Do you hear the"
	line "voices calling?"
	done

HexManiacFVivianBeatenText:
	text "It was only an"
	line "echo?!"
	done
