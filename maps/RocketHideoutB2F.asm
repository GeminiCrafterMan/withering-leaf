RocketHideoutB2F_MapScriptHeader:
	...
	def_object_events
	object_event 20,  6, SPRITE_HEX_MANIAC_F, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_GENERICTRAINER, 2, RocketHideoutB2FHexManiacFCoryn, -1
...
RocketHideoutB2FHexManiacFCoryn:
	generictrainer HEX_MANIAC_F, CORYN, EVENT_BEAT_HEX_MANIAC_F_CORYN, .SeenText, .BeatenText
